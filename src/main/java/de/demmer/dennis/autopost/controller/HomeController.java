    ...
    public String home(Model model) {
        ...
        if (activeUser!=null){
            ...
            for (Page page: activeUser.getPageList()) {
                ...
                Post post = new Post("This is a test post for development","2019-12-11T11:00",page,"1");
                post.setImg("https://upload.wikimedia.org/wikipedia/commons/3/3d/FuBK-Testbild.png");
                post.setEnabled(true);
//                post.setTime("11:00");


                Post post1 = new Post("This is a longer test post for development to test the scheduling table on autoPost","2019-12-11T11:00",page,"1");
...
//                post1.setTime("11:00");
                ...
                Post post2 = new Post("This is a test post for development with a dog picture","2019-12-11T11:00",page,"1");
