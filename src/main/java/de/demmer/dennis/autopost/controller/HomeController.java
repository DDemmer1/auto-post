    ...
    public String home(Model model) {
        ...
        if (activeUser!=null){
            ...
            for (Page page: activeUser.getPageList()) {
                ...
                Post post = new Post("This is a test post for development","11.11.2019",page,"1");
                post.setImg("https://upload.wikimedia.org/wikipedia/commons/3/3d/FuBK-Testbild.png");
                post.setEnabled(true);

                Post post1 = new Post("This is a longer test post for development to test the scheduling table on autoPost","11.11.2019",page,"1");
                post1.setImg("https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Cat03.jpg/1200px-Cat03.jpg");
                post1.setEnabled(false);

                Post post2 = new Post("This is a test post for development with a dog picture","25.12.2019",page,"1");
